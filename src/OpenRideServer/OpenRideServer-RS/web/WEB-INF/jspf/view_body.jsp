        ...
        <div id="content">
                    ...
                    <div class="pickloc">
                        <div class="formstyle">
                            <select id="offerstartdropd" name="dropd01" onChange="">
                                ...
                                <option id="offerstartselectmaplink">Start auf Karte wählen</option>
                            </select>
                        </div>
                    ...
                    <div class="pickloc">
                        <div class="formstyle">
                            <select id="offerdestdropd" name="dropd02" onChange="">
                                ...
                                <option id="offerdestselectmaplink">Ziel auf Karte wählen</option>
                            </select>
                        </div>
                        <div class="picker">
            ...
            <div id="homeUI">
                <div id="homeUI_loading">
                    <h3>Lade persönliche Benutzerdaten &#8230;</h3>
                </div>
                    ...
                    <div class="pickloc">
                        <div class="formstyle">
                            <select id="searchstartdropd" name="dropd05" onChange="">
                                ...
                                <option id="searchstartselectmaplink">Start auf Karte wählen</option>
                            </select>
                        </div>
                        <div style="margin-top:1px;" class="picker">
                    ...
                    <div class="pickloc">
                        <div class="formstyle">
                            <select id="searchdestdropd" name="dropd06" onChange="">
                                ...
                                <option id="searchdestselectmaplink">Ziel auf Karte wählen</option>
                            </select>
                        </div>
                        <div class="picker">
            ...
            <div id="profileUI">
                ...
                <form id="profilepictureform" action="" method="POST" enctype="multipart/form-data" class="profile">
                    ...
                    <input type="submit" value="Profilbild speichern" onclick="if (document.getElementById('profilepicturefile').value != '') { showOverlayDialog('Das Profilbild wird jetzt hochgeladen.', '', 'OK', 'location.reload()', '', ''); } else { showOverlayDialog('Bitte wählen Sie zuerst ein neues Bild aus.', '', 'OK', '', '', ''); return false; }"/>
                    <script type="text/javascript">
                        if (DetectMobileQuick()) {
                            document.write('<div style="color: #999; margin: -0.5em 0 1em 10px; font-size: 12px;">Diese Funktion ist eventuell auf mobilen Webbrowsern nicht verfügbar. Bitte verwenden Sie in diesem Fall einen Webbrowser auf Ihrem Desktop-Computer.</div>');
                        }
                    </script>
                </form>
                ...
                <form id="profileprefsform" action="." class="profile">
                    ...
                    <div>
                        <label for="profileprefissmoker-yes" class="wide">
                            Rauchen w&auml;hrend der Fahrt erwünscht:
                        </label>
                        <br/>
                        <div class="optionlist">
                ...
                <form id="profilepasswordform" action="." class="profile">
                    <p>
                        &Auml;ndern Sie Ihr Passwort für den Zugang zu OpenRide:
                    </p>
                    <div>
                        <label for="">
